        ...
        <div class="space-y-1.5">
          ...
          <div class="mb-2 border-b border-gray-700 pb-1.5">
            ...
            <template v-else-if="tooltipData && isImageUsage(tooltipData)">
              ...
              <div v-if="!hideStandardCost" class="flex items-center justify-between gap-4">
            ...
            <div v-else-if="!hideStandardCost" class="flex items-center justify-between gap-4">
          ...
          <div v-if="!hideStandardCost" class="flex items-center justify-between gap-6">
...
const hideStandardCost = props.hideStandardCost

  ...
  admin: {
    ...
    groups: {
      ...
      form: {
        ...
        firstTokenDelayMs: '首 Token 延迟 (ms)',
        firstTokenDelayMsPlaceholder: '0 表示不延迟',
        firstTokenDelayMsHint: '额外增加首 Token 返回前的等待时间；仅管理员可见，普通用户不可见。',
        exclusiveLabel: '专属分组',
      ...
      rateMultiplierHint: '1.0 = 标准费率，0.5 = 半价，2.0 = 双倍',
      displayRateMultiplierHint: '仅在用户 API 密钥分组处展示，不参与实际计费',
      platforms: {
        all: '全部平台',
        anthropic: 'Anthropic',
        openai: 'OpenAI',
    ...
    riskControl: {
      ...
      recordNonHitsHint: '开启后会记录抽样但未命中的请求摘要，管理员可在审核记录中查看完整摘要。',
    ...
    accounts: {
      ...
      statsExport: '导出统计 Excel',
      statsExportSelected: '导出选中统计',
      statsExported: '账号统计导出成功',
      statsExportFailed: '账号统计导出失败',
      ...
      dataImportFile: '数据文件',
      dataImportNote: '导入备注',
      dataImportNotePlaceholder: '例如：2026-05-17 批量导入 Pro 池账号',
      dataImportNoteHint: '备注会写入新账号备注，并随账号数据导出。',
    ...
    usage: {
      ...
      accountLatencyTitle: '首 Token / 耗时检测',
      accountLatencyTarget: '检测目标：最多 Top20 个账户',
      metricFirstToken: '首 Token',
      metricDuration: '耗时',
      avgFirstToken: '平均首 Token',
      maxFirstToken: '最大首 Token',
      avgDuration: '平均耗时',
      maxDuration: '最大耗时',
      lastUsedAt: '最近使用',
      noAccountLatencyData: '暂无账号检测数据',

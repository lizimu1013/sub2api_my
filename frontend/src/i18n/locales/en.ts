export default {
  ...
  admin: {
    ...
    riskControl: {
      ...
      recordNonHitsHint: 'When enabled, sampled non-hit request summaries are stored for full admin review.',
    ...
    accounts: {
      ...
      statsExport: 'Export Stats Excel',
      statsExportSelected: 'Export Selected Stats',
      statsExported: 'Account stats exported successfully',
      statsExportFailed: 'Failed to export account stats',
      ...
      dataImportNote: 'Import note',
      dataImportNotePlaceholder: 'Example: 2026-05-17 Pro pool account import',
      dataImportNoteHint: 'The note is saved to new account notes and included in account exports.',
    ...
    usage: {
      ...
      accountLatencyTitle: 'First Token / Duration Check',
      accountLatencyTarget: 'Target: up to Top 20 accounts',
      ...
      lastUsedAt: 'Last Used',
      noAccountLatencyData: 'No account check data',

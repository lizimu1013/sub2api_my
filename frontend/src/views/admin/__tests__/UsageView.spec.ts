...
const { list, getStats, getAccountLatency, getAccountLatencyTrend, getSnapshotV2, getModelStats, getById, listErrorLogs, routeQuery } = vi.hoisted(() => {
...
describe('admin UsageView route filters', () => {
  beforeEach(() => {
    ...
    getAccountLatency.mockReset().mockResolvedValue([])
    getAccountLatencyTrend.mockReset().mockResolvedValue([])

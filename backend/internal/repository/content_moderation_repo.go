...
INSERT INTO content_moderation_logs (
    ...
    category_scores, threshold_snapshot, matched_keyword, input_excerpt, upstream_latency_ms, error,
    ...
    $22, $23, $24, $25
		...
		string(categoryScores), string(thresholdSnapshot), log.MatchedKeyword, log.InputExcerpt, latency, log.Error,
...
SELECT
    ...
    l.category_scores, l.threshold_snapshot, l.matched_keyword, l.input_excerpt, l.upstream_latency_ms, l.error,

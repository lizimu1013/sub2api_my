...
const apiKeyAuthSnapshotVersion = 16 // v16: include group web search pricing plus fork video, first-token delay, and peak-rate fields
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			DisplayRateMultiplier:           apiKey.Group.DisplayRateMultiplier,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			DisplayRateMultiplier:           snapshot.Group.DisplayRateMultiplier,

...
func (r *usageBatchLogRepoStub) GetUsageTrendWithFilters(context.Context, time.Time, time.Time, string, int64, int64, int64, int64, string, *int16, *bool, *int8, ...string) ([]usagestats.TrendDataPoint, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) GetModelStatsWithFilters(context.Context, time.Time, time.Time, int64, int64, int64, int64, *int16, *bool, *int8, ...string) ([]usagestats.ModelStat, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GetGroupStatsWithFilters(context.Context, time.Time, time.Time, int64, int64, int64, int64, *int16, *bool, *int8, ...string) ([]usagestats.GroupStat, error) {
	return nil, nil
}
...
func (r *usageBatchLogRepoStub) GetTopAccountLatencyStats(context.Context, usagestats.UsageLogFilters, int) ([]usagestats.AccountLatencyStat, error) {
	return nil, nil
}
func (r *usageBatchLogRepoStub) GetAccountLatencyTrend(context.Context, usagestats.UsageLogFilters, string, int) ([]usagestats.AccountLatencyTrendSeries, error) {
	return nil, nil
}

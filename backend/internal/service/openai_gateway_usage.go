...
func (s *OpenAIGatewayService) adjustOpenAIBalanceCostForLowBalanceDisplayRate(
	...
	adjustedCost, err := s.calculateOpenAIRecordUsageCost(ctx, result, apiKey, billingModels, displayMultiplier, displayMultiplier, displayMultiplier, tokens, serviceTier)
	if err != nil {

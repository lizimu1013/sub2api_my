...
func registerOpsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	ops := admin.Group("/ops")
	{
		...
		ops.GET("/recent-accounts/status", h.Admin.Ops.GetRecentAccountStatus)
...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/stats-export", h.Admin.Account.ExportStats)
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/account-latency", h.Admin.Usage.AccountLatency)
		usage.GET("/account-latency/trend", h.Admin.Usage.AccountLatencyTrend)

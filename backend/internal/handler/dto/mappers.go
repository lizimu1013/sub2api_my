...
func GroupFromServiceAdmin(g *service.Group) *AdminGroup {
	...
	out := &AdminGroup{
		...
		FirstTokenDelayMS:           g.FirstTokenDelayMS,
	}
...
func usageLogFromServiceUser(l *service.UsageLog) UsageLog {
	...
	if l.Group != nil && l.Group.DisplayRateMultiplier > 0 {
		displayRateMultiplier = l.Group.DisplayRateMultiplier
...
func UsageLogFromServiceAdmin(l *service.UsageLog) *AdminUsageLog {
	...
	base.UpstreamEndpoint = l.UpstreamEndpoint
	base.IPAddress = l.IPAddress
